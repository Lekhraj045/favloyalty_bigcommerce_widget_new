...
export default function Home() {
  ...
  return (
    <div>
      {isOpen && (
        <div>
          <div className="w-[390px] right-4 fixed h-[calc(100vh-120px)] bottom-[calc(100px)] max-h-[586px]  rounded-2xl border border-[#DEDEDE] bg-white shadow-sm overflow-hidden">
          {/* Header */}
          <div
