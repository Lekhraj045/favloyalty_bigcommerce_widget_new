    ...
    return (
        <div className="p-4 h-[calc(100vh-130px)] overflow-y-auto custom-scroller">
            <div className='flex flex-col gap-4'>
                <Link href="/redeem-rewards/methods/get-fixed-discoun" className="border border-[#DEDEDE] bg-white rounded-xl p-4 flex items-center gap-3 justify-between hover:shadow-sm transition-all duration-300 cursor-pointer hover:no-underline">
                ...
                <Link href="/redeem-rewards/methods/flat-discount" className="border border-[#DEDEDE] bg-white rounded-xl hover:shadow-sm transition-all duration-300 cursor-pointer hover:no-underline block">
                ...
                <Link href="/redeem-rewards/methods/free-shipping" className="border border-[#DEDEDE] bg-white rounded-xl p-4 flex items-center gap-3 justify-between hover:shadow-sm transition-all duration-300 cursor-pointer hover:no-underline">
                    <div className='flex items-center gap-3'>
                        <div className='w-[40px] h-[40px] bg-linear-to-br from-green-50 to-emerald-50 rounded-lg flex items-center justify-center'>
                            <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/free-shipping.svg`} alt="Free Shipping" width={30} height={30} className='min-w-[30px] min-h-[30px]' />
                        </div>
